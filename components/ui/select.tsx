...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 min-w-32 overflow-hidden rounded-md border shadow-md animate-in fade-in-80",
        "bg-white dark:bg-zinc-950 text-popover-foreground", // ADDED: Solid background colors
        position === "popper" &&
